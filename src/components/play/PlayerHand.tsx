...
const PlayerHand: React.FC<PlayerHandProps> = ({
  ...
  const getCardStyle = (card: Card) => {
    const baseStyle =
      "relative w-20 h-28 rounded-xl shadow-2xl flex flex-col items-center justify-center text-white text-xs text-center p-2 cursor-pointer border-2 overflow-hidden card-in-hand";

    const typeStyles: Record<string, string> = {
      offensive:
        "bg-gradient-to-br from-red-500 to-orange-700 border-red-400 shadow-red-900/50",
      defensive:
        "bg-gradient-to-br from-blue-500 to-indigo-700 border-blue-400 shadow-blue-900/50",
      boost:
        "bg-gradient-to-br from-green-500 to-emerald-700 border-green-400 shadow-green-900/50",
      special:
        "bg-gradient-to-br from-purple-500 to-violet-700 border-purple-400 shadow-purple-900/50",
    };
    ...
    const colorStyles: Record<string, string> = {
      ...
      green:
        "bg-gradient-to-br from-emerald-500 to-green-700 border-green-400 shadow-green-900/50",
      yellow:
        "bg-gradient-to-br from-yellow-400 to-amber-600 border-yellow-400 shadow-yellow-900/50",
      purple:
        "bg-gradient-to-br from-purple-500 to-violet-700 border-purple-400 shadow-purple-900/50",
    };

    const style = card.type
      ? typeStyles[card.type] || typeStyles.offensive
      : card.color
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    initial={{
                      boxShadow: "inset 0 0 0px 0px rgba(255,255,255,0.5)",
                    }}
                    animate={{
                      boxShadow:
